...
const cfg = {
  ...
  CLIENT_PATH: join(Deno.cwd(), "api-key-hash.ts"),
...
const apiKey = isEnabled
  ? crypto.randomUUID().replace(/-/g, "").slice(0, cfg.LEN_BYTES * 2)
  : "";
...
Deno.writeTextFileSync(cfg.CLIENT_PATH, `${cfg.hashPrefix}'${hash}';`);
