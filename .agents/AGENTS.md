...
First read `devenv.sh` script, to see how `src/.env` and `src/data/.env.postgres` files are generated.

Second, the basics of developing the modules in this project and repository are described in README.engine.md file, read it next.
